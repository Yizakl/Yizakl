...
export default function About() {
  return (
    <Layout title="关于我" description="关于我的信息">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div className="md:col-span-1">
            <div className="sticky top-10 bg-white rounded-lg shadow-md overflow-hidden">
              <div className="bg-gradient-to-r from-primary-600 to-primary-800 h-24"></div>
              <div className="px-6 pb-6 text-center -mt-12">
                <div className="rounded-full h-24 w-24 mx-auto bg-gray-100 border-4 border-white flex items-center justify-center mb-4">
